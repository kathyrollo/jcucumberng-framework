...
- [Cucumber Reporting](https://github.com/damianszczepanik/maven-cucumber-reporting) / [Extent Reports](https://github.com/extent-framework) / [Allure](https://github.com/allure-framework) for dynamic HTML test reports
