...
@CucumberOptions(features = { "src/main/resources/features" }, glue = { "project.stepdefs" }, tags = {
		"not @ignore" }, plugin = { "pretty", "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:",
